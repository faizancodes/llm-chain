...
export class OpenAIProvider extends BaseLLMProvider {
  ...
  async chatCompletion(
    ...
    try {
      if (options.stream) {
        throw new Error(
          "OpenAI chat completion streaming is not supported in this method. " +
            "For streaming responses, use the streamChatCompletion() method instead. " +
            "Example: await provider.streamChatCompletion(options, onMessage)"
        );
      }
